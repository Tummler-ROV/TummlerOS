...
import blueos_yellow from '@/assets/img/tummler-logo-yellow.svg'
import blueos_white from '@/assets/img/tummler-logo-white.svg'
...
export default Vue.extend({
  ...
  computed: {
    ...
    blueos_logo(): string {
      return settings.is_dark_theme ? blueos_white : blueos_yellow
    },
  },
